...
class SGEPipelineTask(luigi.Task):
    ...
    def __init__(self, *args, **kwargs):
        super(SGEPipelineTask, self).__init__(*args, **kwargs)
        if self.job_name:
